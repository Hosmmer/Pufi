...
const InputEmail = () => {
    ...
    const handleChange: React.ChangeEventHandler<HTMLInputElement> = ({ target: { value: eventValue } }) => {
        setValue(eventValue);
    };
            ...
            <Row>
                <form>
                    <div className={styles.content}>
                        ...
                        <input type="text" onChange={handleChange} value={value} placeholder='Ingresa tu email' />
                    </div>
                </form>
            </Row>
        </React.Fragment>
